...
const seedData = [
  ...
  },
  {
    ...
    country: 'Greece',
    description:
      'White-washed houses on a cliff with a view of the Aegean Sea.',
  ...
  },
  {
    ...
    country: 'Spain',
    description:
      'Vibrant city known for Gaudí architecture and lively streets.',
  ...
  },
  {
    ...
    country: 'USA',
    description:
      'Tropical paradise with stunning beaches and volcanic landscapes.',
